            ...
            <div className="container" style={{display: "flex", justifyContent: "space-between"}}>
                <div className="firstSection">
                    <div style={{display: "flex", flexDirection: "column", gap: "4vh"}}>
                        ...
                        <h1 className="didYou"> The best houses for <br/> family comfort
                        </h1>
                        <p className="homeAgain">Ectus ipsum faucibus justo, et semper quam nisl in nibh. Pro <br/> in sollicitudin,
                            lorem
                            non posuere blandit.</p>
                        <ButtonS/></div>
                </div>
                <div>
